...
class Ensemble_Model():
    def __init__(self, input_size_sf, hidden_size_sf, output_size_sf, SF_NUM, learning_rate_sf, input_size_ss,
                 hidden_size_ss,
        ...
        # train_sf_flag: la check point load lai model
        ...
        # nn parameters
        # reconstruct_nn_flag: xay dung lai mo hinh
        ...
        self.output_ss_ = []
        for sf_idx in range(SF_NUM):
            # sf_output_list[sf_idx]: ddau ra mang thu nhat
